...
//insert this info into vacc_child table-working
 $query3 = "INSERT INTO vacc_child (symptom1, symptom2, symptom3, vid, dosagedate, childid) VALUES('$symptom1','$symptom2','$symptom3','$vaccineid','$dosagedate','1')";
 $sql = $db->query($query3);
...
$row = $result->fetch_array();
$vaccineid=$row[0];
$query3 = "DELETE FROM vacc_child WHERE vid='$vaccineid' and symptom1='$symptom1' and symptom2='$symptom2' and symptom3='$symptom3' and dosagedate='$dosagedate'";
$sql = $db->query($query3);
...
$row = $result->fetch_array();
$vaccineid=$row[0];
$query = "UPDATE vacc_child SET symptom1='$symptom1' WHERE vid='$vaccineid' and dosagedate='$dosagedate' and childid='1' ";
$result=$db->query($query);
$query = "UPDATE vacc_child SET symptom2='$symptom2' WHERE vid='$vaccineid' and dosagedate='$dosagedate' and childid='1' ";
$result=$db->query($query);
$query = "UPDATE vacc_child SET symptom3='$symptom3' WHERE vid='$vaccineid' and dosagedate='$dosagedate' and childid='1' ";
$result=$db->query($query);
 }	 
...
//insert this info into vacc_child table-working
 $query3 = "INSERT INTO evacc_child (symptom1, symptom2, symptom3, evid, dosagedate, childid) VALUES('$symptom1','$symptom2','$symptom3','$vaccineid','$dosagedate','1')";
 $sql = $db->query($query3);
...
$row = $result->fetch_array();
$vaccineid=$row[0];
$query3 = "DELETE FROM evacc_child WHERE evid='$vaccineid' and symptom1='$symptom1' and symptom2='$symptom2' and symptom3='$symptom3' and dosagedate='$dosagedate'";
$sql = $db->query($query3);
...
$row = $result->fetch_array();
$vaccineid=$row[0];
$query = "UPDATE evacc_child SET symptom1='$symptom1' WHERE evid='$vaccineid' and dosagedate='$dosagedate' and childid='1' ";
$result=$db->query($query);
$query = "UPDATE evacc_child SET symptom2='$symptom2' WHERE evid='$vaccineid' and dosagedate='$dosagedate' and childid='1' ";
$result=$db->query($query);
$query = "UPDATE evacc_child SET symptom3='$symptom3' WHERE evid='$vaccineid' and dosagedate='$dosagedate' and childid='1' ";
$result=$db->query($query);
 }	 
    ...
    <nav class="navbar navbar-inverse">
      ...
      <div class="collapse navbar-collapse js-navbar-collapse">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
            <a href="parentlogin.html">Home</span></a>
          </li>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <form name="form1" method="post" action="createscheduleform.php">
<center>
...
?>                 <tr>
                   <form method="post" action="createscheduleform.php">
...
?>                 <tr>
                   <form method="post" action="createscheduleform.php">
                   <td><input type="text" name="vaccinename" value="<?php echo $row['evaccname']; ?>" readonly></td>
